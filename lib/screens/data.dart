              ...
              child: StreamBuilder<Map<String, dynamic>>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    final titles = data['title'] as List<dynamic>;
                    ...
                    dataByDate.forEach((date, value) {
                      final year = extractYearFromDate(date) ?? "Unknown Year";
                      groupedDataByYear
                          .putIfAbsent(year, () => [])
                          .add({date: value});
                    });
                    ...
                    final sortedYears = groupedDataByYear.keys.toList()
                      ..sort((a, b) =>
                          b.compareTo(a)); // Sort years in descending order
                      ...
                      children: [
                        for (final year in sortedYears)
                          CupertinoListSection.insetGrouped(
                            ...
                            children: [
                              for (final entry in groupedDataByYear[year]!)
                                  ...
                                  CupertinoListTile(
                                    onTap: () {
                                      context.push(DayDataScreen(
                                        date: subEntry.key,
                                        data: subEntry.value as List<dynamic>,
                                        titles: titles,
                                      ));
                                    },
                                    title: Text(subEntry.key), // Key as title
                                    subtitle:
                                        Text("${subEntry.value[0][0]} ..."),
                                    // Value as subtitle
                                    trailing: const Icon(
